...
Scene_SlotMachine.prototype.result = function () {
    ...
    if (this._winCoin < time) {
        ...
        this._winStep = this._winCoin / time * 10 >> 0;
    }
    ...
    if (this._winCoin > 0) {
        ...
        if(this._winCoin >= 10000){
            AudioManager.playMe({"name": "Victory3", "volume": 90, "pitch": 100, "pan": 0});
        } else if(this._winCoin >= 2000){
            AudioManager.playMe({"name": "Victory2", "volume": 90, "pitch": 100, "pan": 0});
        } else if(this._winCoin >= 1000){
