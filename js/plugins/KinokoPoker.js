...
(function () {
    ...
    var parameters = PluginManager.parameters('KinokoPoker');
    ...
    Game_Interpreter.prototype.pluginCommand = function(command, args) {
        ...
        if (command === 'KinokoPoker') {
            switch (args[0]) {
            case 'open':
                SceneManager.push(Scene_KinokoP);
                break;
            case 'changeCname':
...
function Scene_KinokoP() {
    this.initialize.apply(this, arguments);
}

Scene_KinokoP.prototype = Object.create(Scene_MenuBase.prototype);

Scene_KinokoP.prototype.constructor = Scene_KinokoP;

Scene_KinokoP.prototype.initialize = function() {
...
Scene_KinokoP.prototype.create = function() {
...
Scene_KinokoP.prototype.createSelectWindow = function() {
...
Scene_KinokoP.prototype.createWindow = function() {
...
Scene_KinokoP.prototype.drawImage = function(p,id,name,x,y) {
...
Scene_KinokoP.prototype.changeImage = function(p,id,name) {
    this.kinokoBitmap = ImageManager.loadPicture(name);    
    this.kinokoSprite[p][id].bitmap = this.kinokoBitmap;
}

Scene_KinokoP.prototype.clearImage = function(p,id) {   
...
Scene_KinokoP.prototype.update = function() {
...
Scene_KinokoP.prototype.wait = function() {
    this._waitCount--;
...
Scene_KinokoP.prototype.setWait = function(cnt,event) {
    this._waitCount = cnt;
    this._nextEvent = event;
}

Scene_KinokoP.prototype.drawHelp = function() {
...
Scene_KinokoP.prototype.calcFigure = function() {
    this._myFigure = 0;
...
Scene_KinokoP.prototype.terminate = function() {
    Scene_Base.prototype.terminate.call(this);

};

Scene_KinokoP.prototype.getInput = function() {
...
Scene_KinokoP.prototype.myHit = function() {
    var kaburi = true;
    while(kaburi == true){
        kaburi = false;
...
Scene_KinokoP.prototype.enHit = function() {
    var kaburi = true;
    while(kaburi == true){
        kaburi = false;
        var drawCard = parseInt(Math.random() * 52 + 1);
...
Scene_KinokoP.prototype.stand = function() {
    this._status = 5;
...
Scene_KinokoP.prototype.result = function() {
...
Scene_KinokoP.prototype.myDouble = function() {
    this.myHit();
...
Scene_KinokoP.prototype.endGame = function() {
...
Scene_KinokoP.prototype.resetGame = function() {
    if(this._status == 2){
        if(this._myFigure == 21 && this._myCnt == 2){
